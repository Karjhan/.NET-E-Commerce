...
export class CheckoutPaymentComponent implements OnInit {
  ...
  constructor(private basketService: BasketService, private checkoutService: CheckoutService, private toasterService: ToastrService, private router: Router) { }

  ngOnInit(): void {
    loadStripe("pk_test_51O1lWoKVbPxVuJJBN3H2R7dL6ns14wxFrGi8TaAxZCchLaayZA2xiKmODZmhp6qnJ53xsDhcVYonDP2cPZrDLeU000uOl5rMbo").then(stripe => {
      this.stripe = stripe;
